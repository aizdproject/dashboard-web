...
class NodeSensorForm extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" md="12">
            <Card>
              <CardHeader>
                Form <strong>Node Sensor</strong>
              </CardHeader>
              <CardBody>
                <Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
                  <FormGroup row>
                    <Col md="3">
                      <Label htmlFor="node-name">Nama</Label>
                    </Col>
                    <Col xs="12" md="9">
                      <Input type="text" id="node-name" name="node-name" placeholder="Nama node sensor" />
                      <FormText color="muted">Silakan isi nama node sensor</FormText>
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md="3">
                      <Label htmlFor="node-plant">Jenis Tanaman</Label>
                    </Col>
                    <Col xs="12" md="9">
                      <Input type="text" id="node-plant" name="node-plant" placeholder="Jenis tanaman node sensor" />
                      <FormText color="muted">Silakan isi jenis tanaman dari node sensor</FormText>
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md="3">
